...
**What do we need**  
We need an accurate list of airports in China with their localisation
...
What is at stake here is to get the best data set with the minimum amount of
...
We will use the function bellow to load openflights airport data for a specific
country and return a data frame with clean variable names.
