...
the last 3 days of December month for each city in 2015, you can uncomment the 
code to get the full historical data.


```{r scrapingPlan, message=FALSE, warning=FALSE}
# Build the list of dates to be collected
# on this example we chose fews days at the end of 2015
dates4scrapping <- seq(as.Date("2015-12-25"), as.Date("2015-12-31"), by="days")
```
...
Then we loop for each year / city / number of days to collect. The main scraping
...
getDayWeather <- function(
        ...
        # Make base url
        my_url <-paste(city_base_url,date,"&units=metric",sep = "")
...
g <- ggplot(data = weather_data) +
        ...
        ggtitle("Temperature in few cities during the last 3 days of december 2015") +
...
Data from
www.weatherbase.com", col = "black", size = 3, hjust = 0)
g
```
