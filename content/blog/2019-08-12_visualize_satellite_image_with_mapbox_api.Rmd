...
slippymath::raster_to_png(mySat, "../../static/img/from_blog/example_satellite_mapbox_10.png")
knitr::include_graphics("/img/from_blog/example_satellite_mapbox_10.png", error = FALSE)
```
