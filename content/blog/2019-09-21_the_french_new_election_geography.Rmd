...
post we are going to visualize the new shape of France, with a zoom on the region
of Limousin.
...
Limousin was one of the last areas in France where extreme right didn't have
the majority during last european elections, thus we decide to first visualise
the choropleth of election results there.
...
```{r electionChoropleht, message=FALSE, warning=FALSE}
p <- ggplot() +
  geom_polygon(
